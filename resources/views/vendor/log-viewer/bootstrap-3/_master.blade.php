...
<head>
    ...
    <title>Lottery Card Generate - Log-Viewer</title>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="/" class="navbar-brand">
                    <i class="fa fa-fw fa-ticket"></i> Lottery Card Generate
                </a>
            </div>
    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> by @intelguasoft <sup>&copy;</sup>
            </p>
        </div>
    </footer>
